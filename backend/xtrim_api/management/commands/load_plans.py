...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        if not Plan.objects.exists():
            Plan.objects.create(name="Plan Básico", base_price=10.00, mb_included=100, mb_price=0.10, minute_price=0.05, duration=30)
            Plan.objects.create(name="Plan Avanzado", base_price=20.00, mb_included=200, mb_price=0.08, minute_price=0.04, duration=30)
